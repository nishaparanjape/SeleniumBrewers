...
public class common_utils {
	...
	public void loadproperties() {
		...
		// manage program validation page
	...
	public void initWebElements() {
		...
		PageFactory.initElements(DriverManager.getDriver(), ManageProgramPageObj.getInstance());
		PageFactory.initElements(DriverManager.getDriver(), BatchPageObj.getInstance());
	}
